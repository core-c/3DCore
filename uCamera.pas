...
const
  DefaultPosition : TVector = (X:-21.0;Y:20.0;Z:53.0;);
  DefaultTarget   : TVector = (X:-20.0;Y:19.0597;Z:51.7599;);
  DefaultUpY      : TVector = (X:0.0;Y:1.0;Z:0.0;);

  // minder gevoelig < 1 < gevoeliger
  DefaultSensitivityX = 0.25;
  DefaultSensitivityY = 1.0;

  // bewegings-snelheid van een zwevende camera
  DefaultCamSpeed = 250.0;
  // De standaard boudingbox afmetingen
